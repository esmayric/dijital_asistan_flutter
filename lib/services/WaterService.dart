...
class WaterService {
  static const String baseUrl = 'http://192.168.1.3:5000/api/SuTakibi';
  ...
  Future<void> addWaterIntake(double litre, DateTime date) async {
    ...
    if (token == null) {
      print("⚠ Token null geldi. Kullanıcı giriş yapmamış olabilir.");
    ...
    print("➡ Su ekleme isteği gönderiliyor: $requestBody");
